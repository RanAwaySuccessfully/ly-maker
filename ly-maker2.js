...
color  = [colorBG, colorPost, colorDrop, colorText, colorShadow, colorLink, colorLinkHover, colorQuoteLink, colorQuoteHover, colorQuote, colorQuoteShadow, colorCode, colorCodeShadow, colorSpoilerborder, colorSpoiler, colorPostborder, colorQuoteborder, colorCodeborder];
...
function optionsToggle(s) {
    ...
    if (s === -1) {
        ...
        document.getElementById("currentoptions").innerHTML = "<div><strong>Layout Maker XP 2</strong><br>version 1.1</div>";
        layoutGenerator();
        return;
    }
    for (var i = 0; i < tools.length - 1; i++) {
